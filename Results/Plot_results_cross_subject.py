#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Result on MuViHand dataset for cross-subject test protocol!
...
All_threshold = np.load(root + 'All_threshold_cross_sub.npy')
All_pck_curve = np.load(root +'All_pck_curve_cross_sub.npy')
